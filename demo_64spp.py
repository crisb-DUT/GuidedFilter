...
def main():
	rgbBsePath = '/workspace/data/DatasetWithSecondFeature_aug3/64SPP/exr/'
	featureBasePath = '/workspace/data/DatasetWithSecondFeature_aug3/64SPP/Feature/'
	outputPath = '/workspace/data/DatasetWithSecondFeature_aug3/64SPP/guidedfilter/'
