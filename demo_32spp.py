...
def main():
	rgbBsePath = '/workspace/data/DatasetWithSecondFeature_aug3/32SPP/exr/'
	featureBasePath = '/workspace/data/DatasetWithSecondFeature_aug3/32SPP/Feature/'
	outputPath = '/workspace/data/DatasetWithSecondFeature_aug3/32SPP/guidedfilter/'
