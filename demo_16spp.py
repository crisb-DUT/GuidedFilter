...
def main():
	rgbBsePath = '/workspace/data/DatasetWithSecondFeature_aug3/16SPP/exr/'
	featureBasePath = '/workspace/data/DatasetWithSecondFeature_aug3/16SPP/Feature/'
	outputPath = '/workspace/data/DatasetWithSecondFeature_aug3/16SPP/guidedfilter/'
