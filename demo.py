...
def main():
	rgbBsePath = '/workspace/data/DatasetWithSecondFeature_aug3/4SPP/exr/'
	featureBasePath = '/workspace/data/DatasetWithSecondFeature_aug3/4SPP/Feature/'
	outputPath = '/workspace/data/DatasetWithSecondFeature_aug3/4SPP/guidedfilter_winsize2/'
	Gtpath = '/workspace/data/DatasetWithSecondFeature_aug3/GT/'
	scenes = os.listdir(Gtpath)
	for scene in scenes:
